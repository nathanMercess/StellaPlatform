package br.com.linceit.stella.service.assistant;
...
public class AssistantV1Servlet extends HttpServlet {
	...
	private MessageResponse assistantAPICall(String msg) {
		...
		IamOptions options = new IamOptions.Builder()
				...
				.apiKey("2AFInE4VPQ34beBocBUIpCQjrqy5__MdMfwn3rPVOoon")
				.build();
		...
		String workspaceId = "9ba581e9-ff2e-4843-b09f-4635618f175e";
		...
		MessageOptions messageOptions = new MessageOptions.Builder()
				...
				.input(input)
				.context(new Context()) // old this.context - novo sempre cria um contexto novo
				.build();
